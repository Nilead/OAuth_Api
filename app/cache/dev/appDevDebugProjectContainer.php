...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['fos_oauth_server.server'] = new \OAuth2\OAuth2($this->get('fos_oauth_server.storage'), array('supported_scopes' => 'id_access username_access email_access roles_access all_access'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_OauthAuthorizeService()
    {
        ...
        return $this->services['security.firewall.map.context.oauth_authorize'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.in_memory'), 1 => $this->get('fos_user.user_provider.username')), 'oauth_authorize', $b, $this->get('debug.event_dispatcher', ContainerInterface::NULL_ON_INVALID_REFERENCE)), 2 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '53f71244c6a10', $b), 3 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $this->get('security.http_utils'), 'oauth_authorize', NULL, NULL, NULL, $b));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'fos_oauth_server.server.options' => array(
                'supported_scopes' => 'id_access username_access email_access roles_access all_access',
            ),
